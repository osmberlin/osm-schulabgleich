 ...
 */
export function AppModal({ open, onClose, children, panelClassName, zIndex = 70 }: AppModalProps) {
  const z = zIndex
  return (
    <Dialog open={open} onClose={onClose} className="relative" style={{ zIndex: z }}>
